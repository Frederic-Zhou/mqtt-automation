...
func (msc *MockScriptClient) Screenshot() (*models.Response, error) {
	...
	mockTextInfo := []models.TextPosition{
		{Text: "登录", X: 100, Y: 200, Width: 60, Height: 30},
		{Text: "用户名", X: 50, Y: 150, Width: 80, Height: 25},
		{Text: "密码", X: 50, Y: 180, Width: 60, Height: 25},
		{Text: "确定", X: 200, Y: 250, Width: 50, Height: 30},
	}
